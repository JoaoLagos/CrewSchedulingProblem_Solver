...
\nextinstitute
  ...
  Rio de Janeiro, BR.
  \email{\{joaolagos,pessoa2,pessoa3\}@id.uff.br}
}
...
\section{O Problema} \label{sec:o_problema}
...
\section{As Duas Meta-heurísticas}
...
\section{Valor Médio da Solução}
...
\section{Tempo Médio Computacional}
